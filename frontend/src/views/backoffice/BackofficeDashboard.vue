...
.sub { font-size: 0.82rem; color: var(--text-muted); margin-top: 0.2rem; }
...
.metric-body { flex: 1; }
.metric-label { font-size: 0.72rem; font-weight: 700; letter-spacing: 0.06em; text-transform: uppercase; color: var(--text-secondary); margin-bottom: 0.3rem; }
.metric-value { font-size: 1.75rem; font-weight: 900; letter-spacing: -0.03em; color: var(--text-primary); line-height: 1; }
.value-warn  { color: #fbbf24; }
.value-green { color: var(--bip-green); }
.value-red   { color: var(--bip-red); }
.metric-arrow { color: var(--text-muted); font-size: 0.8rem; flex-shrink: 0; }
...
.sc-title  { font-size: 0.875rem; font-weight: 700; color: var(--text-primary); }
.sc-sub    { font-size: 0.75rem; color: var(--text-muted); margin-top: 1px; }
</style>
